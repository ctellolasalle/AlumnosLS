...
# Script para automatizar la instalación de AlumnosLS en un sistema Debian/Ubuntu.
# Se asume que este script se ejecuta desde el directorio raíz del proyecto que ya ha sido copiado al sistema.

# Salir immediately si un comando falla.
set -e
...
log "34" "================================================="
log "34" "        Instalador Automático - AlumnosLS        "
log "34" "================================================="
